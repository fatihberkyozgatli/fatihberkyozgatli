...
export const commands = [
  ...
  { label: "Open Blogs", action: "navigate", target: "#blogs" },
  { label: "You're Not Alone. We've Got This", action: "navigate", target: "/blogs/you-re-not-alone-we-ve-got-this" },
  { label: "Life Keeps Moving Even When You Pause", action: "navigate", target: "/blogs/life-keeps-moving-even-when-you-pause" },
  { label: "The Engineers Ring", action: "navigate", target: "/blogs/the-engineers-ring" },
  { label: "From SMU to the World", action: "navigate", target: "/blogs/from-smu-to-the-world" },
