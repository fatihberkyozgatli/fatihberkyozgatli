        ...
        {project.slug === "image-2-surface" && (
          <>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <div className="bg-destructive/10 border-l-2 border-destructive rounded px-3 py-2 mb-3">
                    <p className="text-sm text-muted-foreground">Depth estimation using neural networks is computationally expensive (5+ seconds), but real-time UX requires end-to-end latency under 5 seconds.</p>
                  </div>
                  <p className="text-sm text-foreground font-medium">Solution:</p>
            ...
            >
              ...
              <div className="space-y-3">
                <div className="bg-card border border-border rounded-lg p-4">
                  <p className="text-sm"><span className="font-semibold text-foreground">5-layer Layered Architecture:</span> <span className="text-muted-foreground">Provides clear separation of concerns. Simplifies adding async processing or microservices in future phases.</span></p>
                </div>
                <div className="bg-card border border-border rounded-lg p-4">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                  ...
                  <p className="text-sm text-muted-foreground">Average end-to-end latency from upload through mesh generation</p>
                </div>
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                  <p className="text-xl font-bold text-primary mb-2">Interactive 3D</p>
                  <p className="text-sm text-muted-foreground">Full-featured viewer with zoom, rotate, and pan controls</p>
                </div>
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                  <p className="text-3xl font-bold text-primary mb-2">1M+</p>
                  <p className="text-sm text-muted-foreground">Vertices efficiently processed on desktop at 60 FPS</p>
                </div>
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                  <p className="text-xl font-bold text-primary mb-2">Full-Stack Integration</p>
                  <p className="text-sm text-muted-foreground">End-to-end system combining PyTorch inference, FastAPI, and React Three Fiber</p>
                </div>
              </div>
            </motion.section>
          </>
            ...
            {project.slug === "image-2-surface" && (
              ...
              >
                <p className="text-sm text-muted-foreground">
                  This is a showcase demonstrating the Image2Surface system capabilities. Explore the full project on{" "}
